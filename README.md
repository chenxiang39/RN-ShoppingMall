## Introduce
This was a simple shopping mall application , l used the React Native framework to create the application's front-end (View and Controller), and also used the nodejs to create the application's back-end.
